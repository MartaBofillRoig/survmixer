...
fun_sim <- function(n0,n1,p0,p1,bshape0,bshape1,ascale0_r,ascale1_r,ascale0_nr,ascale1_nr,ascale_cens,truncated=F,tau=NULL){
  n0= round(n0)
  n1= round(n1)
  ...
  TE_r1 = rweibull(n_r1,scale=ascale1_r,shape=bshape1)
  TE_nr1 = rweibull(n1-n_r1,scale=ascale1_nr,shape=bshape1)
  CE1 = rexp(n1,1/ascale_cens)
  ...
  n_r0 = sum(BE0)
  TE_r0 = rweibull(n_r0,scale=ascale0_r,shape=bshape0)
  TE_nr0 = rweibull(n0-n_r0,scale=ascale0_nr,shape=bshape0)
  CE0 = rexp(n0,1/ascale_cens)
...
fun_simtest <- function(n0,n1,p0,p1,bshape0,bshape1,ascale0_r,ascale1_r,ascale0_nr,ascale1_nr,ascale_cens,truncated,tau){
  db <- fun_sim(n0,n1,p0,p1,bshape0,bshape1,ascale0_r,ascale1_r,ascale0_nr,ascale1_nr,ascale_cens,truncated,tau)
  t <- fun_test(db,tau)
  return(t)
}

fun_simtest_LR <- function(n0,n1,p0,p1,bshape0,bshape1,ascale0_r,ascale1_r,ascale0_nr,ascale1_nr,ascale_cens,truncated,tau){
  db <- fun_sim(n0,n1,p0,p1,bshape0,bshape1,ascale0_r,ascale1_r,ascale0_nr,ascale1_nr,ascale_cens,truncated,tau)
